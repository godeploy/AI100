...
1. [ ] Type a name, and select **Done**.  Close the "How to create an effective LUIS app" dialog.
 ...
 ![Screenshot](https://godeployblob.blob.core.windows.net//labguideimages/AI-100/All-Labs/d5d8f539-cd9e-49da-9566-cc1a060fc88a.png)
...
1. [ ] In the top navigation, select the **BUILD** link.  Notice there is one intent called "None".  Random utterances that don't map to any of your intents may be mapped to "None".
 ...
 ![Screenshot](https://godeployblob.blob.core.windows.net//labguideimages/AI-100/All-Labs/1971f65c-e3c1-44bb-8213-2f3e6ce26c5e.png)
...
1. [ ] Give several examples of things the user might say when greeting the bot, pressing "Enter" after each one.
 ...
 ![Screenshot](https://godeployblob.blob.core.windows.net//labguideimages/AI-100/All-Labs/8453b7c5-3dde-4e14-9c7d-550135820796.png)
...
1. [ ] Select **Done**.
 ...
 ![Screenshot](https://godeployblob.blob.core.windows.net//labguideimages/AI-100/All-Labs/4b896b13-2945-4c8b-a91b-736f2b0ad081.png)
...
1. [ ] Hover and click the word (or click consecutive words to select a group of words) and then select the "facet" entity.
 ...
 ![Screenshot](https://godeployblob.blob.core.windows.net//labguideimages/AI-100/All-Labs/9a23ffbb-3609-47f1-a22e-bde193733f17.png)

 So your utterances may become something like this when facets are labeled:

 ![Screenshot](https://godeployblob.blob.core.windows.net//labguideimages/AI-100/All-Labs/c6762aa3-7e06-4479-afd7-b36106874a02.png)
@@@warning
...
1. [ ] Finally, select **Publish**.
 ...
 ![Screenshot](https://godeployblob.blob.core.windows.net//labguideimages/AI-100/All-Labs/ea5a092e-5ac7-4599-8509-a2704d559c49.png)
...
1. [ ] Select **Test** in the top right bar. Try typing a few utterances and see the intents returned. Familiarize yourself with [interactive testing](https://docs.microsoft.com/en-us/azure/cognitive-services/LUIS/Train-Test#interactive-testing) and [reviewing endpoint utterances](https://docs.microsoft.com/en-us/azure/cognitive-services/LUIS/luis-how-to-review-endoint-utt) as you may want to do this now or in a future lab.
 ...
 ![Screenshot](https://godeployblob.blob.core.windows.net//labguideimages/AI-100/All-Labs/3c3f6951-2110-45b4-bace-4bdd67bd3dac.png)
 ...
 ![Screenshot](https://godeployblob.blob.core.windows.net//labguideimages/AI-100/All-Labs/e1ba05b8-7f84-4547-8d60-bd68f5c006d6.png)
