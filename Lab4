...
##### Task 1 - Using the Bot Framework Emulator
...
1. [ ] Review the bot emulator debug area, notice the following:
 ...
 ![Screenshot](https://godeployblob.blob.core.windows.net//labguideimages/AI-100/All-Labs/7aba407f-8ed8-4e73-a2d6-ce8821277f80.png)
...
1. [ ] As you can see, our current implementation is using in-memory storage. Again, this memory storage is recommended for local bot debugging only. When the bot is restarted, anything stored in memory will be gone.
